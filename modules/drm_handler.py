...
#........................................................................................................................................................................................
            try:
                if m.text:
                    ...
                    if topic == "/yes":
                        if caption == "/cc1":
                            cc = f'🎬 𝐕ɪᴅ 𝐈ᴅ : {str(count).zfill(3)}\n\n**🎞️ 𝐕ɪᴅᴇᴏ 𝐓ɪᴛʟᴇ ➤** `{v_name} [{res}p].mkv`\n\n<blockquote><b>🎓 𝐁ᴀᴛᴄʜ 𝐍ᴀᴍᴇ ➤ {b_name}\nTopic Name : {t_name}</b></blockquote>\n\n**📥 𝐄xᴛʀᴀᴄᴛᴇᴅ 𝐁ʏ ➤ **{CR}\n'
                            cc1 = f'📕 𝐏ᴅꜰ 𝐈ᴅ : {str(count).zfill(3)}\n\n**📁 𝐅ɪʟᴇ 𝐓ɪᴛʟᴇ ➤** `{v_name}.pdf`\n\n<blockquote><b>🎓 𝐁ᴀᴛᴄʜ 𝐍ᴀᴍᴇ ➤ {b_name}\nTopic Name : {t_name}</b></blockquote>\n\n**📥 𝐄xᴛʀᴀᴄᴛᴇᴅ 𝐁ʏ ➤ **{CR}\n'
                            cczip = f'📁 𝐙ɪᴘ 𝐈ᴅ : {str(count).zfill(3)}\n\n**📦 𝐙ɪᴘ 𝐓ɪᴛʟᴇ ➤** `{v_name}.zip`\n\n<blockquote><b>🎓 𝐁ᴀᴛᴄʜ 𝐍ᴀᴍᴇ ➤ {b_name}\nTopic Name : {t_name}</b></blockquote>\n\n**📥 𝐄xᴛʀᴀᴄᴛᴇᴅ 𝐁ʏ ➤ **{CR}\n'
                            ccimg = f'🖼️ 𝐈ᴍɢ 𝐈ᴅ : {str(count).zfill(3)}\n\n**📸 𝐈ᴍᴀɢᴇ 𝐓ɪᴛʟᴇ ➤** `{v_name}.jpg`\n\n<blockquote><b>🎓 𝐁ᴀᴛᴄʜ 𝐍ᴀᴍᴇ ➤ {b_name}\nTopic Name : {t_name}</b></blockquote>\n\n**📥 𝐄xᴛʀᴀᴄᴛᴇᴅ 𝐁ʏ ➤ **{CR}\n'
                            cchtml = f'🌐 𝐇ᴛᴍʟ 𝐈ᴅ : {str(count).zfill(3)}\n\n**💻 𝐇ᴛᴍʟ 𝐓ɪᴛʟᴇ ➤** `{v_name}.html`\n\n<blockquote><b>🎓 𝐁ᴀᴛᴄʜ 𝐍ᴀᴍᴇ ➤ {b_name}\nTopic Name : {t_name}</b></blockquote>\n\n**📥 𝐄xᴛʀᴀᴄᴛᴇᴅ 𝐁ʏ ➤ **{CR}\n'
                            ccyt = f'🎥 𝐕ɪᴅ 𝐈ᴅ : {str(count).zfill(3)}\n\n**🎞️ 𝐕ɪᴅᴇᴏ 𝐓ɪᴛʟᴇ ➤** `{v_name}.mp4`\n\n<a href="{url}">__**Click Here to Watch Stream**__</a>\n<blockquote><b>🎓 𝐁ᴀᴛᴄʜ 𝐍ᴀᴍᴇ ➤ : {b_name}\nTopic Name : {t_name}</b></blockquote>\n\n**📥 𝐄xᴛʀᴀᴄᴛᴇᴅ 𝐁ʏ ➤ **{CR}\n'
                            ccm = f'🎧 𝐌ᴘ𝟹 𝐈ᴅ : {str(count).zfill(3)}\n\n**🎶 𝐀ᴜᴅɪᴏ 𝐓ɪᴛʟᴇ ➤** `{v_name}.mp3`\n\n<blockquote><b>🎓 𝐁ᴀᴛᴄʜ 𝐍ᴀᴍᴇ ➤ {b_name}\nTopic Name : {t_name}</b></blockquote>\n\n**📥 𝐄xᴛʀᴀᴄᴛᴇᴅ 𝐁ʏ ➤ **{CR}\n'
                        elif caption == "/cc2":
                        ...
                        if caption == "/cc1":
                            cc = f'🎬 𝐕ɪᴅ 𝐈ᴅ : {str(count).zfill(3)}\n\n**🎞️ 𝐕ɪᴅᴇᴏ 𝐓ɪᴛʟᴇ ➤ㅤ** `{name1} [{res}p].mkv`\n\n<blockquote><b>🎓 𝐁ᴀᴛᴄʜ 𝐍ᴀᴍᴇ ➤ㅤ</b> {b_name}</blockquote>\n\n**🎯 𝐄xᴛʀᴀᴄᴛᴇᴅ 𝐁ʏ ➤ㅤ **`{CR}`\n'
                            cc1 = f'📕 𝐏ᴅꜰ 𝐈ᴅ : {str(count).zfill(3)}\n\n**📁 𝐅ɪʟᴇ 𝐓ɪᴛʟᴇ ➤ㅤ** `{name1}.pdf`\n\n<blockquote><b>🎓 𝐁ᴀᴛᴄʜ 𝐍ᴀᴍᴇ ➤ㅤ</b> {b_name}</blockquote>\n\n**🎯 𝐄xᴛʀᴀᴄᴛᴇᴅ 𝐁ʏ ➤ㅤ **`{CR}`\n'
                            cczip = f'📁 𝐙ɪᴘ 𝐈ᴅ : {str(count).zfill(3)}\n\n**📦 𝐙ɪᴘ 𝐓ɪᴛʟᴇ ➤ㅤ** `{name1}.zip`\n\n<blockquote><b>🎓 𝐁ᴀᴛᴄʜ 𝐍ᴀᴍᴇ ➤ㅤ</b> {b_name}</blockquote>\n\n**🎯 𝐄xᴛʀᴀᴄᴛᴇᴅ 𝐁ʏ ➤ㅤ **`{CR}`\n' 
                            ccimg = f'🖼️ 𝐈ᴍɢ 𝐈ᴅ : {str(count).zfill(3)}\n\n**📸 𝐈ᴍᴀɢᴇ 𝐓ɪᴛʟᴇ ➤ㅤ** `{name1}.jpg`\n\n<blockquote><b>🎓 𝐁ᴀᴛᴄʜ 𝐍ᴀᴍᴇ ➤ㅤ</b> {b_name}</blockquote>\n\n**🎯 𝐄xᴛʀᴀᴄᴛᴇᴅ 𝐁ʏ ➤ㅤ **`{CR}`\n'
                            ccm = f'🎧 𝐌ᴘ𝟹 𝐈ᴅ : {str(count).zfill(3)}\n\n**🎶 𝐀ᴜᴅɪᴏ 𝐓ɪᴛʟᴇ ➤ㅤ** `{name1}.mp3`\n\n<blockquote><b>🎓 𝐁ᴀᴛᴄʜ 𝐍ᴀᴍᴇ ➤ㅤ</b> {b_name}</blockquote>\n\n**🎯 𝐄xᴛʀᴀᴄᴛᴇᴅ 𝐁ʏ ➤ㅤ **`{CR}`\n'
                            cchtml = f'🌐 𝐇ᴛᴍʟ 𝐈ᴅ : {str(count).zfill(3)}\n\n**💻 𝐇ᴛᴍʟ 𝐓ɪᴛʟᴇ ➤ㅤ** `{name1}.html`\n\n<blockquote><b>🎓 𝐁ᴀᴛᴄʜ 𝐍ᴀᴍᴇ ➤ㅤ</b> {b_name}</blockquote>\n\n**🎯 𝐄xᴛʀᴀᴄᴛᴇᴅ 𝐁ʏ ➤ㅤ **`{CR}`\n'
                        elif caption == "/cc2":
                            cc = f"——— ✦ {str(count).zfill(3)} ✦ ———\n\n<b>🎞️ Title :</b> {name1}\n<b>├── Extention :  {CR} .mkv</b>\n<b>├── Resolution : [{res}]</b>\n<blockquote><b>📚 Course : {b_name}</b></blockquote>\n\n**🌟 Extracted By : {CR}**"
                            cc1 = f"——— ✦ {str(count).zfill(3)} ✦ ———\n\n<b>📁 Title :</b> {name1}\n<b>├── Extention :  {CR} .pdf</b>\n<blockquote><b>📚 Course : {b_name}</b></blockquote>\n\n**🌟 Extracted By : {CR}**"
                            cczip = f"——— ✦ {str(count).zfill(3)} ✦ ———\n\n<b>📒 Title :</b> {name1}\n<b>├── Extention :  {CR} .zip</b>\n<blockquote><b>📚 Course : {b_name}</b></blockquote>\n\n**🌟 Extracted By : {CR}**"
